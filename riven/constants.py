...
riven_DIR = os.path.join(os.path.expanduser("~"), ".riven")
riven_TOOL_EXECUTION_DIR = os.path.join(riven_DIR, "tool_execution_dir")

riven_MODEL_ENDPOINT = "https://inference.riven.com/v1/"
...
riven_CORE_TOOL_MODULE_NAME = "riven.functions.function_sets.base"
riven_MULTI_AGENT_TOOL_MODULE_NAME = "riven.functions.function_sets.multi_agent"
riven_VOICE_TOOL_MODULE_NAME = "riven.functions.function_sets.voice"
riven_BUILTIN_TOOL_MODULE_NAME = "riven.functions.function_sets.builtin"
riven_FILES_TOOL_MODULE_NAME = "riven.functions.function_sets.files"
...
DEFAULT_riven_MODEL = "gpt-4"  # TODO: fixme
...
DEPRECATED_riven_TOOLS = ["archival_memory_insert", "archival_memory_search"]
...
# Set of all built-in riven tools
riven_TOOL_SET = set(
    BASE_TOOLS
    + BASE_MEMORY_TOOLS
    + MULTI_AGENT_TOOLS
...
# The error message that riven will receive
...
REDIS_DEFAULT_CACHE_PREFIX = "riven_cache"
...
# builtin web search
WEB_SEARCH_MODEL_ENV_VAR_NAME = "riven_BUILTIN_WEBSEARCH_OPENAI_MODEL_NAME"
