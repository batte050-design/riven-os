...
from riven.errors import LLMEmptyResponseError
...
from riven.server.rest_api.json_parser import JSONParser, PydanticJSONParser
            ...
            if isinstance(delta, BetaTextDelta):
                ...
                if self.tool_call_name == DEFAULT_MESSAGE_TOOL and self.use_assistant_message:
                    ...
                    if self.inner_thoughts_complete:
                        if prev_message_type and prev_message_type != "tool_call_message":
                            message_index += 1
                        tool_call_msg.otid = Message.generate_otid_from_id(self.riven_message_id, message_index)
                        prev_message_type = tool_call_msg.message_type
                        yield tool_call_msg
                    else:
                        self.tool_call_buffer.append(tool_call_msg)
