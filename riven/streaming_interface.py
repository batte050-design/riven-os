...
from riven.interface import CLIInterface
from riven.local_llm.constants import ASSISTANT_MESSAGE_CLI_SYMBOL, INNER_THOUGHTS_CLI_SYMBOL
from riven.schemas.message import Message
from riven.schemas.openai.chat_completion_response import ChatCompletionChunkResponse, ChatCompletionResponse
...
class AgentChunkStreamingInterface(ABC):
    """Interfaces handle riven-related events (observer pattern)
