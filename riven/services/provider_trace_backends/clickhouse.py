...
from riven.services.clickhouse_provider_traces import ClickhouseProviderTraceReader
from riven.services.provider_trace_backends.base import ProviderTraceBackendClient
from riven.settings import settings

if TYPE_CHECKING:
    from riven.schemas.llm_trace import LLMTrace
...
class ClickhouseProviderTraceBackend(ProviderTraceBackendClient):
    ...
    async def create_async(
        ...
        try:
            from riven.services.llm_trace_writer import get_llm_trace_writer
