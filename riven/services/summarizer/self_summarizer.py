...
from riven.schemas.enums import MessageRole, ProviderType
...
from riven.services.summarizer.constants import SUMMARY_TRUNCATION_SUFFIX
from riven.services.summarizer.summarizer_config import CompactionSettings, get_default_prompt_for_mode
...
async def self_summarize_all(
    ...
    # This mirrors the logic in riven_agent_v3.py step processing
    ...
    from riven.services.summarizer.summarizer import _run_summarizer_request
