...
from riven.constants import FUNCTION_RETURN_VALUE_TRUNCATED
from riven.helpers.datetime_helpers import AsyncTimer
...
from riven.services.tool_executor.builtin_tool_executor import rivenBuiltinToolExecutor
from riven.services.tool_executor.core_tool_executor import rivenCoreToolExecutor
from riven.services.tool_executor.files_tool_executor import rivenFileToolExecutor
from riven.services.tool_executor.mcp_tool_executor import ExternalMCPToolExecutor
from riven.services.tool_executor.sandbox_tool_executor import SandboxToolExecutor
from riven.services.tool_executor.tool_executor_base import ToolExecutor
from riven.utils import get_friendly_error_msg
...
class ToolExecutorFactory:
    ...
    _executor_map: ClassVar[Dict[ToolType, Type[ToolExecutor]]] = {
        ToolType.riven_CORE: rivenCoreToolExecutor,
        ToolType.riven_MEMORY_CORE: rivenCoreToolExecutor,
        ToolType.riven_SLEEPTIME_CORE: rivenCoreToolExecutor,
        ToolType.riven_MULTI_AGENT_CORE: SandboxToolExecutor,
        ToolType.riven_BUILTIN: rivenBuiltinToolExecutor,
        ToolType.riven_FILES_CORE: rivenFileToolExecutor,
