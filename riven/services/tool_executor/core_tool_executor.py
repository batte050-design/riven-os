...
class rivenCoreToolExecutor(ToolExecutor):
    """Executor for riven core tools with direct implementation of functions."""
    ...
    async def conversation_search(
        ...
        try:
            ...
            from riven.constants import CONVERSATION_SEARCH_TOOL_NAME
