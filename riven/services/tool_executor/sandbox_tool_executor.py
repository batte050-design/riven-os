...
from riven.services.sandbox_credentials_service import SandboxCredentialsService
from riven.services.tool_executor.tool_executor_base import ToolExecutor
from riven.services.tool_sandbox.local_sandbox import AsyncToolSandboxLocal
    ...
    async def execute(
        ...
        try:
            ...
            if tool_requests_modal and modal_configured:
                try:
                    from riven.services.tool_sandbox.modal_sandbox import AsyncToolSandboxModal
                    ...
                    # TODO: pass through riven api key
            ...
            if tool_execution_result is None:
                if tool_settings.sandbox_type == SandboxType.E2B:
                    from riven.services.tool_sandbox.e2b_sandbox import AsyncToolSandboxE2B
