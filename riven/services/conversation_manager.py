...
from riven.orm.block import Block as BlockModel
from riven.orm.blocks_conversations import BlocksConversations
from riven.orm.conversation import Conversation as ConversationModel
from riven.orm.conversation_messages import ConversationMessage as ConversationMessageModel
...
from riven.schemas.block import Block as PydanticBlock
from riven.schemas.conversation import Conversation as PydanticConversation, CreateConversation, UpdateConversation
...
class ConversationManager:
    ...
    async def list_conversation_messages(
        ...
        async with db_registry.async_session() as session:
            ...
            # Convert to rivenMessages (reverse=False keeps sub-messages in natural order)
            return PydanticMessage.to_riven_messages_from_list(
    ...
    async def _create_isolated_blocks(
        ...
        Raises:
            rivenInvalidArgumentError: If a block label is not found on the agent
        """
