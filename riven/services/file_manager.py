...
from riven.constants import MAX_FILENAME_LENGTH
from riven.helpers.pinecone_utils import list_pinecone_index_for_files, should_use_pinecone
from riven.log import get_logger
from riven.orm.errors import NoResultFound
from riven.orm.file import FileContent as FileContentModel, FileMetadata as FileMetadataModel
from riven.orm.sqlalchemy_base import AccessType
from riven.otel.tracing import trace_method
from riven.schemas.enums import FileProcessingStatus, PrimitiveType
...
from riven.schemas.source_metadata import FileStats, OrganizationSourcesStats, SourceStats
...
from riven.utils import bounded_gather, enforce_types
...
class FileManager:
    ...
    async def get_organization_sources_metadata(
        ...
        async with db_registry.async_session() as session:
            ...
            from riven.orm.source import Source as SourceModel
    ...
    async def get_files_for_agents_async(
        ...
        async with db_registry.async_session() as session:
            ...
            from riven.orm.files_agents import FileAgent as FileAgentModel
