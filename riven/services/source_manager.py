...
from riven.schemas.source import Source as PydanticSource, SourceUpdate
from riven.schemas.user import User as PydanticUser
from riven.server.db import db_registry
from riven.utils import bounded_gather, decrypt_agent_secrets, enforce_types, printd
    ...
    async def _upsert_sources_individually(self, source_data_list: List[PydanticSource], actor: PydanticUser) -> List[PydanticSource]:
        ...
        for source in source_data_list:
            ...
            if existing_source:
                ...
                from riven.schemas.source import SourceUpdate
