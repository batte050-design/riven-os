...
from riven.model_aliases import get_deprecated_google_handle_replacement
from riven.orm.provider import Provider as ProviderModel
from riven.orm.provider_model import ProviderModel as ProviderModelORM
from riven.otel.tracing import trace_method
from riven.schemas.embedding_config import EmbeddingConfig
from riven.schemas.enums import PrimitiveType, ProviderCategory, ProviderType
from riven.schemas.llm_config import LLMConfig
from riven.schemas.provider_model import ProviderModel as PydanticProviderModel
from riven.schemas.providers import Provider as PydanticProvider, ProviderCheck, ProviderCreate, ProviderUpdate
...
AUTO_MODE_HANDLES = ["riven/auto", "riven/auto-fast", "riven/auto-chat"]
...
class ProviderManager:
    ...
    async def sync_base_providers(self, base_providers: list[PydanticProvider], actor: PydanticUser) -> None:
        ...
        """
        from riven.log import get_logger
        from riven.orm.errors import UniqueConstraintViolationError
    ...
    async def get_llm_config_from_handle(
        ...
        if handle in AUTO_MODE_HANDLES:
            ...
            if handle == "riven/auto":
                model_name = "auto"
            elif handle == "riven/auto-fast":
        ...
        if hasattr(typed_provider, "openai_compat_base_url"):
            ...
            from riven.schemas.providers.chatgpt_oauth import CHATGPT_CODEX_ENDPOINT
