...
on the local filesystem (~/.riven/memfs/ by default). This enables
...
from riven.constants import CORE_MEMORY_BLOCK_CHAR_LIMIT
...
from riven.schemas.memory_repo import MemoryCommit
from riven.schemas.user import User as PydanticUser
from riven.services.memory_repo.block_markdown import parse_block_markdown, serialize_block
from riven.services.memory_repo.git_operations import GitOperations
from riven.services.memory_repo.path_mapping import memory_block_label_from_markdown_path
...
DEFAULT_LOCAL_PATH = os.path.expanduser("~/.riven/memfs")
...
class MemfsClient:
    ...
    def __init__(self, base_url: str | None = None, local_path: str | None = None, timeout: float = 120.0):
        ...
        Args:
            ...
            local_path: Path for local storage (default: ~/.riven/memfs)
    ...
    async def create_repo_async(
        ...
        return await self.git.create_repo(
            ...
            author_email=f"{actor.id}@riven.ai",
        )
    ...
    async def update_block_async(
        ...
        *,
        ...
        Returns:
            Commit details
        """
        from riven.schemas.memory_repo import FileChange
