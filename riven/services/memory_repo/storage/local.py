...
class LocalStorageBackend(StorageBackend):
    ...
    ~/.riven/memfs/. This enables git-backed memory for self-hosted
    ...
    def __init__(
        ...
        Args:
            base_path: Base directory for storage (default: ~/.riven/memfs)
            prefix: Prefix for all paths in this backend (default: "repository")
        """
        if base_path is None:
            base_path = os.path.expanduser("~/.riven/memfs")
