...
from riven.orm import ArchivalPassage, Archive as ArchiveModel, ArchivesAgents
from riven.otel.tracing import trace_method
from riven.schemas.agent import AgentState as PydanticAgentState
from riven.schemas.archive import Archive as PydanticArchive
from riven.schemas.embedding_config import EmbeddingConfig
from riven.schemas.enums import PrimitiveType, VectorDBProvider
...
class ArchiveManager:
    ...
    async def get_agents_for_archive_async(
        ...
        """
        from riven.orm import Agent as AgentModel
