...
from riven.orm.sandbox_config import SandboxConfig as SandboxConfigModel, SandboxEnvironmentVariable as SandboxEnvVarModel
from riven.otel.tracing import trace_method
from riven.schemas.enums import PrimitiveType, SandboxType
from riven.schemas.environment_variables import (
    SandboxEnvironmentVariable as PydanticEnvVar,
    SandboxEnvironmentVariableCreate,
    SandboxEnvironmentVariableUpdate,
)
from riven.schemas.sandbox_config import (
    E2BSandboxConfig,
    LocalSandboxConfig,
    ModalSandboxConfig,
...
from riven.utils import enforce_types, printd
    ...
    def get_or_create_default_sandbox_config(self, sandbox_type: SandboxType, actor: PydanticUser) -> PydanticSandboxConfig:
        ...
        if not sandbox_config:
            ...
            if sandbox_type == SandboxType.E2B:
                ...
                # LOCAL sandbox type
                default_local_sandbox_path = riven_TOOL_EXECUTION_DIR
