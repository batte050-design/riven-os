...
from riven.orm.job import Job as JobModel
...
from riven.schemas.enums import JobStatus, JobType, MessageRole, PrimitiveType
from riven.schemas.job import BatchJob as PydanticBatchJob, Job as PydanticJob, JobUpdate, rivenRequestConfig
...
class JobManager:
    ...
    async def get_run_messages(
        ...
        Returns:
            List of rivenMessages associated with the job
        ...
        messages = PydanticMessage.to_riven_messages_from_list(
            messages=messages,
    ...
    async def _get_run_request_config(self, run_id: str) -> rivenRequestConfig:
        """
        ...
        async with db_registry.async_session() as session:
            ...
            request_config = job.request_config or rivenRequestConfig()
