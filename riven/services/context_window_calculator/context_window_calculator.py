...
from riven.schemas.memory import ContextWindowOverview
from riven.schemas.message import Message
from riven.schemas.user import User as PydanticUser
from riven.services.context_window_calculator.token_counter import TokenCounter
...
class ContextWindowCalculator:
    ...
    def _extract_system_prompt(system_message: str) -> Optional[str]:
        ...
        (e.g. custom system prompts from riven Code agents), falls back to
        ...
        Note:
            ...
            - Custom prompt agents (e.g. riven Code): raw preamble text without any tags
        """
    ...
    def extract_system_components(system_message: str) -> Dict[str, Optional[str]]:
        ...
        - Custom system prompts without <base_instructions> (e.g. riven Code agents)
