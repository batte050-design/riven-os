...
from riven.services.tool_sandbox.base import AsyncToolSandboxBase
from riven.services.tool_sandbox.modal_constants import DEFAULT_MAX_CONCURRENT_INPUTS, DEFAULT_PYTHON_VERSION
from riven.services.tool_sandbox.modal_deployment_manager import ModalDeploymentManager
from riven.services.tool_sandbox.modal_version_manager import ModalVersionManager
from riven.services.tool_sandbox.safe_pickle import SafePickleError, safe_pickle_dumps, sanitize_for_pickle
...
class AsyncToolSandboxModalV2(AsyncToolSandboxBase):
    ...
    def _get_modal_image(self, sbx_config: SandboxConfig) -> modal.Image:
        ...
        # Include dependencies required by riven's ORM modules
