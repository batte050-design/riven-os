...
class BaseAgentV2(ABC):
    """
    Abstract base class for the main agent execution loop for riven agents, handling
    ...
    ) -> AsyncGenerator[rivenMessage | LegacyrivenMessage | MessageStreamStatus, None]:
        """
