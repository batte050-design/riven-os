...
from riven.server.constants import WS_DEFAULT_PORT
from riven.server.server import SyncServer
from riven.server.ws_api.interface import SyncWebSocketInterface
...
class WebSocketServer:
    ...
    async def start_server(self):
        ...
        # and https://github.com/riven-ai/riven/issues/471
