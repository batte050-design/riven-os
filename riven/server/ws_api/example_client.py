...
import riven.server.ws_api.protocol as protocol
from riven.helpers.json_helpers import json_dumps, json_loads
from riven.server.constants import WS_CLIENT_TIMEOUT, WS_DEFAULT_PORT
from riven.server.utils import condition_to_stop_receiving, print_server_response
...
async def basic_cli_client():
    """Basic example of a riven CLI client that connects to a riven server.py process via WebSockets
