...
from riven.server.rest_api.interface import QueuingInterface
...
class AuthRequest(BaseModel):
    password: str = Field(None, description="Admin password provided when starting the riven server")
