...
from riven.errors import rivenInvalidArgumentError, rivenUnsupportedFileUploadError
from riven.helpers.pinecone_utils import (
...
from riven.schemas.enums import DuplicateFileHandling, FileProcessingStatus
from riven.schemas.file import FileMetadata
from riven.schemas.folder import Folder
from riven.schemas.passage import Passage
from riven.schemas.source import Source, SourceCreate, SourceUpdate
from riven.schemas.source_metadata import OrganizationSourcesStats
...
from riven.services.file_processor.file_types import get_allowed_media_types, get_extension_to_mime_type_map, register_mime_types
...
from riven.utils import safe_create_file_processing_task, safe_create_task, sanitize_filename
from riven.validators import FileId, FolderId
...
async def upload_file_to_folder(
    ...
    if media_type not in allowed_media_types:
        raise rivenUnsupportedFileUploadError(
            message=(
