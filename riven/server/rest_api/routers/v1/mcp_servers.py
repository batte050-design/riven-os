...
from riven.errors import rivenMCPConnectionError
from riven.functions.mcp_client.types import SSEServerConfig, StdioServerConfig, StreamableHTTPServerConfig
from riven.log import get_logger
from riven.schemas.mcp_server import (
...
from riven.server.rest_api.dependencies import (
    HeaderParams,
    get_headers,
    get_riven_server,
)
...
from riven.services.mcp.oauth_utils import drill_down_exception, oauth_stream_event
    ...
    async def oauth_stream_generator(
        ...
        try:
            ...
            try:
                ...
                return
            except (ConnectionError, rivenMCPConnectionError):
