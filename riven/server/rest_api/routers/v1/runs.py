...
from riven.errors import rivenExpiredError, rivenInvalidArgumentError
from riven.helpers.datetime_helpers import get_utc_time
from riven.schemas.enums import RunStatus
from riven.schemas.riven_message import rivenMessageUnion
from riven.schemas.riven_request import RetrieveStreamRequest
...
from riven.schemas.run import Run
from riven.schemas.run_metrics import RunMetrics
from riven.schemas.step import Step
...
from riven.services.clickhouse_otel_traces import ClickhouseOtelTracesReader
...
async def retrieve_trace_for_run(
    ...
    if not settings.clickhouse_endpoint:
        raise HTTPException(
            status_code=501,
            detail="OTEL traces require ClickHouse. Set riven_CLICKHOUSE_ENDPOINT and configure ClickHouse connection.",
        )
