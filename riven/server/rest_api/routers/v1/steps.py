...
from riven.services.step_manager import FeedbackType
from riven.settings import settings
from riven.validators import StepId
...
@router.get("/{step_id}/messages", response_model=List[rivenMessageUnion], operation_id="list_messages_for_step")
async def list_messages_for_step(
    ...
    return Message.to_riven_messages_from_list(messages)
