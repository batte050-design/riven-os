...
This module provides easy integration with the existing riven application,
...
from riven.otel.sqlalchemy_instrumentation import (
...
def setup_riven_db_instrumentation(
    enable_joined_monitoring: bool = True,
    sql_truncate_length: int = 1000,
    additional_config: Optional[Dict[str, Any]] = None,
) -> None:
    """
    Set up SQLAlchemy instrumentation for riven application.
...
def teardown_riven_db_instrumentation() -> None:
    """Tear down SQLAlchemy instrumentation for riven application."""
...
def configure_riven_db_instrumentation(**kwargs) -> None:
    """
    Configure SQLAlchemy instrumentation for riven application.
...
def setup_fastapi_db_instrumentation(app, **config_kwargs):
    ...
    async def startup_db_instrumentation():
        setup_riven_db_instrumentation(**config_kwargs)
