...
from riven.helpers.datetime_helpers import ns_to_ms
from riven.log import get_logger
from riven.otel.context import add_ctx_attribute, get_ctx_attributes
...
def get_riven_meter() -> Meter:
    """Returns the global riven meter if metrics are initialized."""
