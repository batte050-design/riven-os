...
def add_exception_context(exception: Exception, **context) -> Exception:
    ...
    This attaches a __riven_context__ attribute to the exception with structured data.
    ...
    """
    if not hasattr(exception, "__riven_context__"):
        exception.__riven_context__ = {}
    exception.__riven_context__.update(context)
    return exception
