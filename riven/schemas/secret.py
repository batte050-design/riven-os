...
from riven.helpers.crypto_utils import CryptoUtils
from riven.log import get_logger
from riven.utils import bounded_gather
...
class Secret(BaseModel):
    ...
    def from_plaintext(cls, value: Optional[str]) -> "Secret":
        ...
        If riven_ENCRYPTION_KEY is configured, the value is encrypted.
        ...
        try:
            ...
            if "No encryption key configured" in str(e):
                logger.warning(
                    ...
                    "Set riven_ENCRYPTION_KEY environment variable to enable encryption."
                )
