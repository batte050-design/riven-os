...
from riven.schemas.enums import PrimitiveType, RunStatus
...
class Run(RunBase):
    ...
    request_config: Optional[rivenRequestConfig] = Field(None, description="The request configuration for the run.")
