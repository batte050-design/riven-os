...
from riven.constants import riven_TOOL_EXECUTION_DIR, MODAL_DEFAULT_TIMEOUT
from riven.schemas.agent import AgentState
from riven.schemas.enums import PrimitiveType, SandboxType
from riven.schemas.riven_base import rivenBase, OrmMetadataBase
    ...
    def set_default_sandbox_dir(cls, data):
        ...
        if data.get("sandbox_dir") is None:
            if tool_settings.tool_exec_dir:
                ...
                data["sandbox_dir"] = riven_TOOL_EXECUTION_DIR
