...
from riven.schemas.enums import AgentStepStatus, JobStatus, PrimitiveType, ProviderType
...
class LLMBatchJob(OrmMetadataBase, validate_assignment=True):
    ...
    riven_batch_job_id: str = Field(..., description="ID of the riven batch job")
