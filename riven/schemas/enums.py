...
class PrimitiveType(str, Enum):
    """
    Enum for all primitive resource types in riven.
...
class ToolType(str, Enum):
    CUSTOM = "custom"
    riven_CORE = "riven_core"
    riven_MEMORY_CORE = "riven_memory_core"
    riven_MULTI_AGENT_CORE = "riven_multi_agent_core"
    riven_SLEEPTIME_CORE = "riven_sleeptime_core"
    riven_VOICE_SLEEPTIME_CORE = "riven_voice_sleeptime_core"
    riven_BUILTIN = "riven_builtin"
    riven_FILES_CORE = "riven_files_core"
...
class ActorType(str, Enum):
    riven_USER = "riven_user"
    riven_AGENT = "riven_agent"
    riven_SYSTEM = "riven_system"
