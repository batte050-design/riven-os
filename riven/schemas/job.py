...
if TYPE_CHECKING:
    from riven.schemas.riven_request import rivenRequest
...
from riven.schemas.enums import JobStatus, JobType
...
class rivenRequestConfig(BaseModel):
    ...
    @classmethod
    def from_riven_request(cls, request: "rivenRequest") -> "rivenRequestConfig":
        """Create a rivenRequestConfig from a rivenRequest."""
        return cls(
