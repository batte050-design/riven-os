...
class rivenImage(ImageSource):
    type: Literal[ImageSourceType.riven] = Field(default=ImageSourceType.riven, description="The source type for the image.")
...
ImageSourceUnion = Annotated[Union[UrlImage, Base64Image, rivenImage], Field(discriminator="type")]
...
rivenUserMessageContentUnion = Annotated[
    Union[TextContent, ImageContent],
    Field(discriminator="type"),
]


def create_riven_user_message_content_union_schema():
    return {
        "oneOf": [
...
def get_riven_user_message_content_union_str_json_schema():
    return {
        "anyOf": [
            {
                "type": "array",
                "items": {
                    "$ref": "#/components/schemas/rivenUserMessageContentUnion",
                },
            },
            {"type": "string"},
        ],
...
rivenToolReturnContentUnion = Annotated[
    Union[TextContent, ImageContent],
    Field(discriminator="type"),
]


def create_riven_tool_return_content_union_schema():
    return {
        "oneOf": [
            {"$ref": "#/components/schemas/TextContent"},
            {"$ref": "#/components/schemas/ImageContent"},
...
def get_riven_tool_return_content_union_str_json_schema():
        ...
        "anyOf": [
            {
                "type": "array",
                "items": {
                    "$ref": "#/components/schemas/rivenToolReturnContentUnion",
                },
            },
            {"type": "string"},
        ],
...
rivenAssistantMessageContentUnion = Annotated[
    Union[TextContent],
    Field(discriminator="type"),
]


def create_riven_assistant_message_content_union_schema():
    return {
        "oneOf": [
            {"$ref": "#/components/schemas/TextContent"},
        ],
...
def get_riven_assistant_message_content_union_str_json_schema():
    return {
        "anyOf": [
            {
                "type": "array",
                "items": {
                    "$ref": "#/components/schemas/rivenAssistantMessageContentUnion",
                },
            },
            {"type": "string"},
        ],
...
rivenMessageContentUnion = Annotated[
    Union[
        TextContent,
        ImageContent,
        ToolCallContent,
...
def create_riven_message_content_union_schema():
    return {
        "oneOf": [
            {"$ref": "#/components/schemas/TextContent"},
            {"$ref": "#/components/schemas/ImageContent"},
...
def get_riven_message_content_union_str_json_schema():
    return {
        "anyOf": [
            {
                "type": "array",
                "items": {
                    "$ref": "#/components/schemas/rivenMessageContentUnion",
                },
            },
            {"type": "string"},
        ],
