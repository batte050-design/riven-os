...
from riven.constants import MIN_CONTEXT_WINDOW
from riven.errors import ErrorCode, LLMAuthenticationError, LLMPermissionDeniedError
...
from riven.schemas.providers.openai import OpenAIProvider
...
class TogetherProvider(OpenAIProvider):
    ...
    async def list_embedding_models_async(self) -> list[EmbeddingConfig]:
        logger.warning(
            "riven does not currently support listing embedding models for Together. Please "
