...
from riven.constants import CORE_MEMORY_BLOCK_CHAR_LIMIT, CORE_MEMORY_LINE_NUMBER_WARNING
from riven.otel.tracing import trace_method
from riven.schemas.block import Block, FileBlock
from riven.schemas.enums import AgentType
from riven.schemas.file import FileStatus
...
class Memory(BaseModel, validate_assignment=True):
    ...
    def compile(self, tool_usage_rules=None, sources=None, max_files_open=None, llm_config=None, client_skills=None) -> str:
        ...
        if llm_config and hasattr(llm_config, "model_endpoint_type"):
            ...
            is_line_numbered_agent_type = norm_type in ("sleeptime_agent", "memgpt_v2_agent", "riven_v1_agent")
