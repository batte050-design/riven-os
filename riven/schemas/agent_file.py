...
from riven.schemas.file import FileAgent, FileAgentBase, FileMetadata, FileMetadataBase
from riven.schemas.group import (
    Group,
    GroupCreate,
    ManagerConfig,
    ManagerType,
...
from riven.schemas.source import Source, SourceCreate
...
class SkillSchema(BaseModel):
    ...
    - source_url: reference to resolve later (e.g., 'riven:slack')
    ...
    source_url: Optional[str] = Field(
        default=None,
        description="Source URL for skill resolution (e.g., 'riven:slack', 'anthropic:pdf', 'owner/repo/path')",
    )
