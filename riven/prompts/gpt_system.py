...
from riven.prompts.system_prompts import SYSTEM_PROMPTS
...
def get_system_text(key):
    ...
    # fallback to user custom prompts in ~/.riven/system_prompts/*.txt
    filename = f"{key}.txt"
    user_system_prompts_dir = os.path.join(riven_DIR, "system_prompts")
