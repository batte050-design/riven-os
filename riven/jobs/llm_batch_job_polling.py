...
from riven.jobs.helpers import map_anthropic_batch_job_status_to_job_status, map_anthropic_individual_batch_item_status_to_job_status
from riven.jobs.types import BatchPollingResult, ItemUpdateInfo
from riven.log import get_logger
from riven.otel.tracing import trace_method
from riven.schemas.enums import JobStatus, ProviderType
from riven.schemas.riven_response import rivenBatchResponse
from riven.schemas.llm_batch_job import LLMBatchJob
...
@trace_method
async def poll_running_llm_batches(server: "SyncServer") -> List[rivenBatchResponse]:
    """
        ...
        if item_updates:
            ...
            async def _resume(batch_row: LLMBatchJob) -> rivenBatchResponse:
                ...
                return await runner.resume_step_after_request(
                    riven_batch_id=batch_row.riven_batch_job_id,
