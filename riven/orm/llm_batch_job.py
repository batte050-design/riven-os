...
from riven.orm.custom_columns import CreateBatchResponseColumn, PollBatchResponseColumn
from riven.orm.mixins import OrganizationMixin
from riven.orm.sqlalchemy_base import SqlalchemyBase
from riven.schemas.enums import JobStatus, ProviderType
from riven.schemas.llm_batch_job import LLMBatchJob as PydanticLLMBatchJob
...
class LLMBatchJob(SqlalchemyBase, OrganizationMixin):
    ...
    riven_batch_job_id: Mapped[str] = mapped_column(
        String, ForeignKey("jobs.id", ondelete="CASCADE"), nullable=False, doc="ID of the riven batch job"
    )
