...
if TYPE_CHECKING:
    ...
    from riven.orm.step import Step

from openai.types.chat.chat_completion_message_tool_call import ChatCompletionMessageToolCall as OpenAIToolCall
from sqlalchemy import BigInteger, FetchedValue, ForeignKey, Index, event, text
from sqlalchemy.orm import Mapped, Session, mapped_column, relationship

from riven.orm.custom_columns import ApprovalsColumn, MessageContentColumn, ToolCallColumn, ToolReturnColumn
from riven.orm.mixins import AgentMixin, OrganizationMixin
...
from riven.schemas.riven_message_content import MessageContent, TextContent, TextContent as PydanticTextContent
from riven.schemas.message import Message as PydanticMessage, ToolReturn
