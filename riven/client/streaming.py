...
from riven.constants import OPENAI_CONTEXT_WINDOW_ERROR_SUBSTRING
from riven.errors import LLMError
from riven.log import get_logger
from riven.schemas.enums import MessageStreamStatus
from riven.schemas.riven_message import AssistantMessage, HiddenReasoningMessage, ReasoningMessage, ToolCallMessage, ToolReturnMessage
from riven.schemas.riven_response import rivenStreamingResponse
from riven.schemas.usage import rivenUsageStatistics

logger = get_logger(__name__)


def _sse_post(url: str, data: dict, headers: dict) -> Generator[Union[rivenStreamingResponse, ChatCompletionChunk], None, None]:
    """
                ...
                for sse in event_source.iter_sse():
                    if sse.data in {status.value for status in MessageStreamStatus}:
                        ...
                        if "reasoning" in chunk_data:
                            ...
                            yield rivenUsageStatistics(**chunk_data)
