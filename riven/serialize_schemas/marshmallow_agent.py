...
import riven
from riven.orm import Agent, Message as MessageModel
from riven.schemas.agent import AgentState as PydanticAgentState
from riven.schemas.user import User
from riven.serialize_schemas.marshmallow_agent_environment_variable import SerializedAgentEnvironmentVariableSchema
from riven.serialize_schemas.marshmallow_base import BaseSchema
from riven.serialize_schemas.marshmallow_block import SerializedBlockSchema
from riven.serialize_schemas.marshmallow_custom_fields import EmbeddingConfigField, LLMConfigField, ToolRulesField
from riven.serialize_schemas.marshmallow_message import SerializedMessageSchema
from riven.serialize_schemas.marshmallow_tag import SerializedAgentTagSchema
from riven.serialize_schemas.marshmallow_tool import SerializedToolSchema
...
class MarshmallowAgentSchema(BaseSchema):
    ...
    def sanitize_ids(self, data: Dict, **kwargs):
        ...
        data[self.FIELD_VERSION] = riven.__version__
    ...
    def check_version(self, data, **kwargs):
        ...
        if version != riven.__version__:
            print(f"Version mismatch: expected {riven.__version__}, got {version}")
