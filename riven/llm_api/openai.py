...
from riven.helpers.datetime_helpers import timestamp_to_datetime
from riven.llm_api.helpers import add_inner_thoughts_to_functions, convert_to_structured_output
from riven.llm_api.openai_client import (
...
from riven.schemas.message import Message as PydanticMessage, MessageRole as _MessageRole
...
from riven.utils import get_tool_call_id, smart_urljoin
...
def openai_chat_completions_process_stream(
    ...
    To "stream" the response in riven, we want to call a streaming-compatible interface function
...
def openai_chat_completions_request_stream(
    ...
    # In riven config the address for vLLM is w/o a /v1 suffix for simplicity
