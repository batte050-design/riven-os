...
from riven.errors import rivenConfigurationError, RateLimitExceededError
from riven.llm_api.helpers import unpack_all_inner_thoughts_from_kwargs
from riven.log import get_logger

logger = get_logger(__name__)
from riven.llm_api.openai import (
    build_openai_chat_completions_request,
    openai_chat_completions_process_stream,
    openai_chat_completions_request,
    prepare_openai_payload,
)
from riven.local_llm.chat_completion_proxy import get_chat_completion
...
from riven.schemas.enums import LLMCallType, ProviderCategory
...
from riven.schemas.provider_trace import ProviderTrace
from riven.services.telemetry_manager import TelemetryManager
from riven.settings import ModelSettings
from riven.streaming_interface import AgentChunkStreamingInterface, AgentRefreshStreamingInterface
...
def create(
    ...
    if llm_config.model_endpoint_type in ["openai", "openrouter"]:
        if model_settings.openai_api_key is None and llm_config.model_endpoint == "https://api.openai.com/v1":
            ...
            raise rivenConfigurationError(message="OpenAI key is missing from riven config file", missing_fields=["openai_api_key"])
