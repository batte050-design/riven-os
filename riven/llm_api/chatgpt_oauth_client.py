...
from riven.schemas.providers.chatgpt_oauth import ChatGPTOAuthCredentials, ChatGPTOAuthProvider
...
class ChatGPTOAuthClient(LLMClientBase):
    ...
    def extract_usage_statistics(self, response_data: dict | None, llm_config: LLMConfig) -> rivenUsageStatistics:
        """Extract usage statistics from ChatGPT OAuth response and return as rivenUsageStatistics."""
    ...
    def handle_llm_error(self, e: Exception, llm_config: Optional[LLMConfig] = None) -> Exception:
        ...
        # Already a typed LLM/riven error (e.g. from SSE error handling) — pass through
        if isinstance(e, rivenError):
            return e
