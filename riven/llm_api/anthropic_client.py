...
from riven.constants import FUNC_FAILED_HEARTBEAT_MESSAGE, REQ_HEARTBEAT_MESSAGE, REQUEST_HEARTBEAT_PARAM
...
from riven.llm_api.anthropic_constants import ANTHROPIC_MAX_STRICT_TOOLS, ANTHROPIC_STRICT_MODE_ALLOWLIST
from riven.llm_api.error_utils import is_insufficient_credits_message
from riven.llm_api.helpers import add_inner_thoughts_to_functions, unpack_all_inner_thoughts_from_kwargs
from riven.llm_api.llm_client_base import LLMClientBase
from riven.local_llm.constants import INNER_THOUGHTS_KWARG, INNER_THOUGHTS_KWARG_DESCRIPTION
...
from riven.schemas.openai.chat_completion_request import Tool as OpenAITool
...
class AnthropicClient(LLMClientBase):
    ...
    def build_request_data(
        ...
        prefix_fill = True if agent_type != AgentType.riven_v1_agent else False
        is_v1 = agent_type == AgentType.riven_v1_agent
        ...
        if not tools:
            ...
            tool_choice = None
        elif (self.is_reasoning_model(llm_config) and llm_config.enable_reasoner) or agent_type == AgentType.riven_v1_agent:
    ...
    def extract_usage_statistics(self, response_data: dict | None, llm_config: LLMConfig) -> rivenUsageStatistics:
        """Extract usage statistics from Anthropic response and return as rivenUsageStatistics."""
