...
from riven.constants import NON_USER_MSG_PREFIX
...
from riven.helpers.datetime_helpers import get_utc_time_int
from riven.helpers.json_helpers import json_dumps, json_loads, sanitize_unicode_surrogates
from riven.llm_api.error_utils import is_insufficient_credits_message
from riven.llm_api.llm_client_base import LLMClientBase
from riven.local_llm.json_parser import clean_json_string_extra_backslash
...
from riven.schemas.openai.chat_completion_request import Tool, Tool as OpenAITool
from riven.schemas.openai.chat_completion_response import ChatCompletionResponse, Choice, FunctionCall, Message, ToolCall, UsageStatistics
from riven.schemas.usage import rivenUsageStatistics
from riven.settings import model_settings, settings
from riven.utils import get_tool_call_id
...
class GoogleVertexClient(LLMClientBase):
    ...
    def add_dummy_model_messages(messages: List[dict]) -> List[dict]:
        ...
        In riven, the 'model' will often call a function (e.g. send_message) that itself yields to the user,
    ...
    def convert_tools_to_google_ai_format(self, tools: List[Tool], llm_config: LLMConfig) -> List[dict]:
        ...
        for func in function_list:
            ...
            if llm_config.put_inner_thoughts_in_kwargs:
                from riven.local_llm.constants import INNER_THOUGHTS_KWARG_DESCRIPTION, INNER_THOUGHTS_KWARG_VERTEX
    ...
    def build_request_data(
        ...
        contents = self.add_dummy_model_messages(
            PydanticMessage.to_google_dicts_from_list(
                ...
                put_inner_thoughts_in_kwargs=False if agent_type == AgentType.riven_v1_agent else True,
                native_content=True if agent_type == AgentType.riven_v1_agent else False,
            ),
        )
    ...
    def extract_usage_statistics(self, response_data: dict | None, llm_config: LLMConfig) -> rivenUsageStatistics:
        """Extract usage statistics from Gemini response and return as rivenUsageStatistics."""
                ...
                for response_message in parts:
                    ...
                    if response_message.function_call:
                        ...
                        if llm_config.put_inner_thoughts_in_kwargs:
                            ...
                            from riven.local_llm.constants import INNER_THOUGHTS_KWARG_VERTEX
    ...
    async def count_tokens(
        ...
        """
        from riven.llm_api.google_constants import GOOGLE_MODEL_FOR_API_KEY_CHECK
