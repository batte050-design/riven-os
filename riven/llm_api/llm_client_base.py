...
from riven.errors import ErrorCode, LLMConnectionError, LLMError
from riven.otel.tracing import log_event, trace_method
from riven.schemas.embedding_config import EmbeddingConfig
from riven.schemas.enums import AgentType, LLMCallType, ProviderCategory
...
from riven.schemas.provider_trace import BillingContext, ProviderTrace
...
class LLMClientBase:
    ...
    def extract_usage_statistics(self, response_data: Optional[dict], llm_config: LLMConfig) -> rivenUsageStatistics:
        """Provider-specific usage parsing hook (override in subclasses). Returns rivenUsageStatistics."""
    ...
    async def request_async_with_telemetry(self, request_data: dict, llm_config: LLMConfig) -> dict:
        ...
        riven_TELEMETRY_PROVIDER_TRACE_BACKEND.
        """
