...
from riven.schemas.openai.chat_completion_response import ChatCompletionResponse, ChoiceLogprobs, ToolCall
...
class rivenLLMAdapter(ABC):
    ...
    def __init__(
        ...
        self.usage: rivenUsageStatistics = rivenUsageStatistics()
    ...
    async def invoke_llm(
        ...
        Yields:
            rivenMessage: Chunks of data for streaming adapters, or None for blocking adapters
        """
