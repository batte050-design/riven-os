...
from riven.schemas.riven_message_content import OmittedReasoningContent, ReasoningContent, TextContent
...
class rivenLLMRequestAdapter(rivenLLMAdapter):
    """
    ...
    async def invoke_llm(
        ...
        actor: str | None = None,
    ) -> AsyncGenerator[rivenMessage | None, None]:
        """
