...
from riven.interfaces.anthropic_parallel_tool_call_streaming_interface import SimpleAnthropicStreamingInterface
from riven.interfaces.gemini_streaming_interface import SimpleGeminiStreamingInterface
from riven.interfaces.openai_streaming_interface import SimpleOpenAIResponsesStreamingInterface, SimpleOpenAIStreamingInterface
from riven.llm_api.openai_client import OpenAIClient
from riven.otel.tracing import log_attributes, safe_json_dumps, trace_method
...
from riven.server.rest_api.streaming_response import get_cancellation_event_for_run
from riven.settings import settings
from riven.utils import safe_create_task


class SimpleLLMStreamAdapter(rivenLLMStreamAdapter):
    """
    ...
    async def invoke_llm(
    ...
    ) -> AsyncGenerator[rivenMessage, None]:
        """
        ...
        try:
            ...
            try:
                self.message_id = self.interface.riven_message_id
            except Exception:
