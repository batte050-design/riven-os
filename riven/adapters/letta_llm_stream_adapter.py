...
from riven.llm_api.openai_ws_session import OpenAIWSSessionManager
from riven.otel.tracing import log_attributes, safe_json_dumps, trace_method
from riven.schemas.enums import LLMCallType, ProviderType
...
class rivenLLMStreamAdapter(rivenLLMAdapter):
    """
