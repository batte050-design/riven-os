...
from riven.constants import CLI_WARNING_PREFIX
from riven.errors import LocalLLMConnectionError, LocalLLMError
from riven.helpers.datetime_helpers import get_utc_time_int
from riven.helpers.json_helpers import json_dumps
from riven.local_llm.constants import DEFAULT_WRAPPER
from riven.local_llm.function_parser import patch_function
from riven.local_llm.grammars.gbnf_grammar_generator import create_dynamic_model_from_function, generate_gbnf_grammar_and_documentation
from riven.local_llm.koboldcpp.api import get_koboldcpp_completion
from riven.local_llm.llamacpp.api import get_llamacpp_completion
from riven.local_llm.llm_chat_completion_wrappers import simple_summary_wrapper
from riven.local_llm.lmstudio.api import get_lmstudio_completion, get_lmstudio_completion_chatcompletions
from riven.local_llm.ollama.api import get_ollama_completion
from riven.local_llm.utils import get_available_wrappers
from riven.local_llm.vllm.api import get_vllm_completion
from riven.local_llm.webui.api import get_webui_completion
from riven.local_llm.webui.legacy_api import get_webui_completion as get_webui_completion_legacy
from riven.otel.tracing import log_event
from riven.prompts.gpt_summarize import SYSTEM as SUMMARIZE_SYSTEM_MESSAGE
from riven.schemas.message import Message as PydanticMessage
from riven.schemas.openai.chat_completion_response import ChatCompletionResponse, Choice, Message, ToolCall, UsageStatistics
...
def get_chat_completion(
    ...
    from riven.utils import printd
    ...
    if grammar is not None and endpoint_type not in grammar_supported_backends:
        print(
            f"{CLI_WARNING_PREFIX}grammars are currently not supported when using {endpoint_type} as the riven local LLM backend (supported: {', '.join(grammar_supported_backends)})"
        )
        grammar = None
