...
from riven.local_llm.settings.settings import get_completions_settings
from riven.local_llm.utils import post_json_auth_request
    ...
    settings.update(
        {
            ...
            # In riven we handle this ourselves, so this should be disabled
            # "context_overflow_policy": 0,
            # "lmstudio": {"context_overflow_policy": 0},  # 0 = stop at limit
            # "lmstudio": {"context_overflow_policy": "stopAtLimit"}, # https://github.com/riven-ai/riven/issues/1782
            "stream": False,
            "model": "local model",
        }
    )
