from riven.errors import LLMJSONParsingError
from riven.helpers.json_helpers import json_dumps, json_loads
from riven.local_llm.json_parser import clean_json
from riven.local_llm.llm_chat_completion_wrappers.wrapper_base import LLMChatCompletionWrapper
...
class ChatMLInnerMonologueWrapper(LLMChatCompletionWrapper):
    ...
    def _clean_function_args(self, function_name, function_args):
        """Some basic riven-specific cleaning of function args"""
