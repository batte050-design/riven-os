...
from riven.functions.async_composio_toolset import AsyncComposioToolSet
from riven.utils import run_async_task
...
def {func_name}(**kwargs):
    raise RuntimeError("Something went wrong - we should never be using the persisted source code for Composio. Please reach out to riven team")
"""
