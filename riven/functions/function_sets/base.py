...
from riven.constants import CORE_MEMORY_LINE_NUMBER_WARNING
...
def memory(
    ...
    """
    raise NotImplementedError("This should never be invoked directly. Contact riven if you see this error message.")
...
def conversation_search(
    ...
    from riven.constants import RETRIEVAL_QUERY_DEFAULT_PAGE_SIZE
