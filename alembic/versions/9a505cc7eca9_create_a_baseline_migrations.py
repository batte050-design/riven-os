...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("llm_config", riven.orm.custom_columns.LLMConfigColumn(), nullable=True),
        sa.Column("embedding_config", riven.orm.custom_columns.EmbeddingConfigColumn(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(), nullable=True),
        sa.Column("tool_calls", riven.orm.message.ToolCallColumn(), nullable=True),
